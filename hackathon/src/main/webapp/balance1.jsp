...
<div class="login-container">
    <h2>Check Balance <img alt="svg" height="25px" src="images/money.svg"> </h2>
    <form class="login-form" action="otp.jsp" >
		...
		<input type="hidden" name="amount" value="0" disabled>
		<input type="hidden" name="sourcePage" value="balance1.jsp">
